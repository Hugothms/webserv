...
/*   Updated: 2021/11/12 13:20:04 by hthomas          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Server
{
	private :
		...
		list<string>		cgi; // "Host" header in HTTP request (domain names)
	...
	public:
		...
		void set_cgi(const list<string> cgi);
